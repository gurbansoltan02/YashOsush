...
def upload_portfolio(directory, file):
    BASE_PATH = f"/portfolio_uploads/{directory}/"
...
def delete_uploaded_portfolio(portfolio_name):
    path_for_remove = sys.path[0] + portfolio_name
